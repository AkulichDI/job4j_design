...
public class PreparedStatementDemo {
    ...
    public void initConnection() throws SQLException {
        ...
        String  url = "url=jdbc:postgresql://localhost:5432/idea_db";
    ...
    public City insert (City city ){
        ...
        try (PreparedStatement statement = connection.prepareStatement("INSERT INTO cities (name, population ) VALUE (?,?)",
